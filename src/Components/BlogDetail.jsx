// BlogDetail.jsx - Updated with navbar inside hero card
...
const BlogDetail = () => {
  ...
  return (
    <div className={`blog-detail-page ${isDark ? 'dark' : 'light'}`}>
      ...
      {/* HERO — navbar INSIDE the glassmorphic hero card (matches reference screenshot 13) */}
      <section className="blog-detail-hero">
        <div className="blog-detail-hero-card">

          {/* Decorative swirl/lime background element */}
            ...
            <div className="navbar-container">
              <Link to="/" className="logo">
                <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
                  <rect width="28" height="28" rx="5" fill="url(#lgBD)" />
                  <path d="M14 7L19 17H9L14 7Z" fill="white" />
                  <defs>
                    <linearGradient id="lgBD" x1="0" y1="0" x2="28" y2="28">
          ...
          <div className="blog-detail-hero-content">
            <span className="blog-detail-badge">{blogPost.badge}</span>
            <h1 className="blog-detail-title">{blogPost.title}</h1>
            <p className="blog-detail-excerpt">{blogPost.excerpt}</p>
            <div className="blog-detail-meta">
              <span className="meta-pill-blog">{blogPost.date}</span>
              <span className="meta-pill-blog">{blogPost.author}</span>
              <span className="meta-pill-blog">
        ...
        <div className="container-blog-detail">
          ...
          <div className="blog-footer-section">
            <div className="share-section">
              <h3 className="share-heading">Share this article</h3>
